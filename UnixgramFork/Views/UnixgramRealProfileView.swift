                ...
                HStack(alignment: .top) {
                    ...
                    NavigationLink {
                        ...
                        Image(systemName: "bag.fill")
                            .font(.system(size: 18, weight: .semibold))
                            .foregroundStyle(Color(red: 0.80, green: 0.56, blue: 1.0))
                            .frame(width: 42, height: 42)
                            .background(
                                Circle()
                                    .fill(Color.purple.opacity(0.14))
                                    .shadow(color: Color.purple.opacity(0.36), radius: 12)
                            )
                            .overlay(
                                Circle()
                ...
                HStack(spacing: 14) {
                    ZStack {
                        RoundedRectangle(cornerRadius: 16, style: .continuous)
                            .fill(
                                LinearGradient(
                                    colors: [.purple.opacity(0.70), .indigo.opacity(0.42)],
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        Text("Маркет подарков")
                            ...
                            .foregroundStyle(.white)
                        Text("Смотреть и покупать реальные подарки Unixgram")
                            .font(.system(size: 13))
                            .foregroundStyle(.secondary)
                    }
    ...
    var body: some View {
        VStack(spacing: 16) {
            ...
            Button {
                ...
                Label("Открыть маркет подарков", systemImage: "bag.fill")
                    .font(.system(size: 17, weight: .bold))
                    .frame(maxWidth: .infinity)
                    .frame(height: 54)
                    .background(
